...
Quokkas are found on some smaller islands off the coast of Western Australia, particularly Rottnest Island just off Perth and Bald Island near Albany. Isolated, scattered populations also exist in forest and coastal heath between Perth and Albany. A small colony inhabits a protected area of Two Peoples Bay Nature Reserve, where they co-exist with the critically endangered Gilbert's potoroo.</p>
      ...
      <header class="site-header">
          <div>
            <a class="title1" href="#FFF">Dicovery and name</a>
          </div>
      </header>
...
In 1658, Dutch mariner Samuel Volckertzoon wrote of sighting "a wild cat" on the island. In 1696, Dutch explorer Willem de Vlamingh mistook them for giant rats, and renamed the Wadjemup island 't Eylandt 't Rottenest, which means "the rat nest island" in Dutch.</p>
      ...
      <div>
        <a class="title4" href="#">Population</a>
      </div>
...
The quokka is now listed as vulnerable in accordance with the IUCN criteria.
      ...
      <header class="site-header" >
          <div>
            <div class="container noPrint">
                <a href="#interaction" class="btn btn-danger">Human interaction</a>
            </div>
          </div>
      </header>
